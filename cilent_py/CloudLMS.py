...
class LMSApp:
    ...
    def connect_db(self):
        ...
        messagebox.showerror(
            "Database Connection MySQLError",
    ...
    def login(self):
        ...
        if not username or not password:
            messagebox.showerror("MySQLError", "Please enter both username and password")
            return
        ...
        try:
            ...
            if user:
                ...
                messagebox.showerror("MySQLError", "Invalid credentials!")
        except MySQLError as e:
            messagebox.showerror("Database MySQLError", f"MySQLError during login: {e}")
    ...
    def register_user(self):
        ...
        if not all([username, email, password]):
            messagebox.showerror("MySQLError", "Please fill all fields")
            return
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError during registration: {e}")
    ...
    def load_courses(self, tree):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError loading courses: {e}")
    ...
    def enroll_course(self, tree):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError enrolling: {e}")
    ...
    def submit_assignment(self, tree):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError submitting assignment: {e}")
    ...
    def load_student_assignments(self, tree):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError loading assignments: {e}")
    ...
    def load_student_grades(self, tree):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError loading grades: {e}")
    ...
    def create_course(self):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError creating course: {e}")
    ...
    def create_assignment(self):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError creating assignment: {e}")
    ...
    def load_submissions(self, event=None):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError loading submissions: {e}")
    ...
    def view_submission_file(self):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError viewing file: {e}")
        except Exception as e:
            messagebox.showerror("MySQLError", f"Could not open file: {e}")
    ...
    def submit_grade(self):
        ...
        try:
            ...
            messagebox.showerror("MySQLError", "Please enter a valid number for score")
        except MySQLError as e:
            messagebox.showerror("Database MySQLError", f"MySQLError submitting grade: {e}")
    ...
    def load_all_users(self, tree):
        ...
        try:
            ...
            messagebox.showerror("Database MySQLError", f"MySQLError loading users: {e}")
    ...
    def delete_user(self):
        ...
        if messagebox.askyesno("Confirm Delete", f"Are you sure you want to delete user '{username}'?"):
            try:
                ...
                messagebox.showerror("Database MySQLError", f"MySQLError deleting user: {e}")
    ...
    def show_add_user_dialog(self):
        ...
        def add_user():
            ...
            try:
                ...
                messagebox.showerror("Database MySQLError", f"MySQLError adding user: {e}")
    ...
    def edit_user(self):
        ...
        def update_user():
            ...
            try:
                ...
                messagebox.showerror("Database MySQLError", f"MySQLError updating user: {e}")
